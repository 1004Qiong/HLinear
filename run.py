...
parser.add_argument('--checkpoints', type=str, default='/tmp/lzq_checkpoints/HLinear/', help='location of model checkpoints')
...
parser.add_argument('--enc_in', type=int, default=n, help='encoder input size') # DLinear with --individual, use this hyperparameter as the number of channels
parser.add_argument('--dec_in', type=int, default=n, help='decoder input size')
parser.add_argument('--c_out', type=int, default=n, help='output size')
